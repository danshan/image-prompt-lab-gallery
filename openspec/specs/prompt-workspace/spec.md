...
Define Prompt Workspace as a first-class prompt management surface, including prompt drafts, immutable prompt versions, template rendering, prompt-sourced generation, and prompt-to-output lineage.

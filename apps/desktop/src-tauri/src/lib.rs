...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::list_archived_content,
            commands::library::restore_asset,
            commands::library::restore_prompt_document,
            commands::library::dry_run_permanent_delete_archived_content,
            commands::library::permanent_delete_archived_content,
            commands::library::dry_run_merge_library,
            commands::library::merge_library,
            ...
            commands::gallery::archive_asset,
            ...
            commands::prompts::archive_prompt_document,
